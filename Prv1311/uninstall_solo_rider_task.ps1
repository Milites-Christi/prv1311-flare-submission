<#
Removes the PRV1311-SoloRider scheduled task. Does not stop/kill any
...
MUST be run from an elevated ("Run as Administrator") PowerShell:
    ...
    powershell -ExecutionPolicy Bypass -File "C:\Users\Autry\accum-flip\Prv1311\uninstall_solo_rider_task.ps1"
#>
